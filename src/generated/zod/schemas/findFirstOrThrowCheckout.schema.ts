...
export const CheckoutFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CheckoutSelect> = z.object({
...
export const CheckoutFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    billId: z.boolean().optional(),
    itemId: z.boolean().optional(),
    quantity: z.boolean().optional(),
...
export const CheckoutFindFirstOrThrowSchema: z.ZodType<Prisma.CheckoutFindFirstOrThrowArgs> = z.object({ select: CheckoutFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CheckoutIncludeObjectSchema.optional()), orderBy: z.union([CheckoutOrderByWithRelationInputObjectSchema, CheckoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: CheckoutWhereInputObjectSchema.optional(), cursor: CheckoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CheckoutScalarFieldEnumSchema, CheckoutScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CheckoutFindFirstOrThrowArgs>;

export const CheckoutFindFirstOrThrowZodSchema = z.object({ select: CheckoutFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CheckoutIncludeObjectSchema.optional()), orderBy: z.union([CheckoutOrderByWithRelationInputObjectSchema, CheckoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: CheckoutWhereInputObjectSchema.optional(), cursor: CheckoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CheckoutScalarFieldEnumSchema, CheckoutScalarFieldEnumSchema.array()]).optional() }).strict();