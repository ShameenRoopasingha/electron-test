...
export const SupplierFindFirstSelectSchema: z.ZodType<Prisma.SupplierSelect> = z.object({
...
export const SupplierFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    email: z.boolean().optional(),
    phone: z.boolean().optional(),
...
export const SupplierFindFirstSchema: z.ZodType<Prisma.SupplierFindFirstArgs> = z.object({ select: SupplierFindFirstSelectSchema.optional(), include: z.lazy(() => SupplierIncludeObjectSchema.optional()), orderBy: z.union([SupplierOrderByWithRelationInputObjectSchema, SupplierOrderByWithRelationInputObjectSchema.array()]).optional(), where: SupplierWhereInputObjectSchema.optional(), cursor: SupplierWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SupplierScalarFieldEnumSchema, SupplierScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SupplierFindFirstArgs>;

export const SupplierFindFirstZodSchema = z.object({ select: SupplierFindFirstSelectSchema.optional(), include: z.lazy(() => SupplierIncludeObjectSchema.optional()), orderBy: z.union([SupplierOrderByWithRelationInputObjectSchema, SupplierOrderByWithRelationInputObjectSchema.array()]).optional(), where: SupplierWhereInputObjectSchema.optional(), cursor: SupplierWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SupplierScalarFieldEnumSchema, SupplierScalarFieldEnumSchema.array()]).optional() }).strict();