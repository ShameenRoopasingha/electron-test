...
export const BillFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BillSelect> = z.object({
...
export const BillFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    customerId: z.boolean().optional(),
    totalAmount: z.boolean().optional(),
...
export const BillFindFirstOrThrowSchema: z.ZodType<Prisma.BillFindFirstOrThrowArgs> = z.object({ select: BillFindFirstOrThrowSelectSchema.optional(), include: BillIncludeObjectSchema.optional(), orderBy: z.union([BillOrderByWithRelationInputObjectSchema, BillOrderByWithRelationInputObjectSchema.array()]).optional(), where: BillWhereInputObjectSchema.optional(), cursor: BillWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BillScalarFieldEnumSchema, BillScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BillFindFirstOrThrowArgs>;

export const BillFindFirstOrThrowZodSchema = z.object({ select: BillFindFirstOrThrowSelectSchema.optional(), include: BillIncludeObjectSchema.optional(), orderBy: z.union([BillOrderByWithRelationInputObjectSchema, BillOrderByWithRelationInputObjectSchema.array()]).optional(), where: BillWhereInputObjectSchema.optional(), cursor: BillWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BillScalarFieldEnumSchema, BillScalarFieldEnumSchema.array()]).optional() }).strict();