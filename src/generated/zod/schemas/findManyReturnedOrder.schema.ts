...
export const ReturnedOrderFindManySchema: z.ZodType<Prisma.ReturnedOrderFindManyArgs> = z.object({ select: ReturnedOrderFindManySelectSchema.optional(), include: z.lazy(() => ReturnedOrderIncludeObjectSchema.optional()), orderBy: z.union([ReturnedOrderOrderByWithRelationInputObjectSchema, ReturnedOrderOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReturnedOrderWhereInputObjectSchema.optional(), cursor: ReturnedOrderWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReturnedOrderScalarFieldEnumSchema, ReturnedOrderScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReturnedOrderFindManyArgs>;

export const ReturnedOrderFindManyZodSchema = z.object({ select: ReturnedOrderFindManySelectSchema.optional(), include: z.lazy(() => ReturnedOrderIncludeObjectSchema.optional()), orderBy: z.union([ReturnedOrderOrderByWithRelationInputObjectSchema, ReturnedOrderOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReturnedOrderWhereInputObjectSchema.optional(), cursor: ReturnedOrderWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReturnedOrderScalarFieldEnumSchema, ReturnedOrderScalarFieldEnumSchema.array()]).optional() }).strict();