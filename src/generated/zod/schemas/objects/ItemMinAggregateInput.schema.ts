...
export const ItemMinAggregateInputObjectSchema: z.ZodType<Prisma.ItemMinAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.ItemMinAggregateInputType>;
export const ItemMinAggregateInputObjectZodSchema = makeSchema();
