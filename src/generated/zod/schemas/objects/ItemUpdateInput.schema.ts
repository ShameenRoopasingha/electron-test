...
export const ItemUpdateInputObjectSchema: z.ZodType<Prisma.ItemUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.ItemUpdateInput>;
export const ItemUpdateInputObjectZodSchema = makeSchema();
