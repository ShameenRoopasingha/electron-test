...
export const ItemCountOutputTypeCountExpiredItemsArgsObjectSchema = makeSchema();
export const ItemCountOutputTypeCountExpiredItemsArgsObjectZodSchema = makeSchema();
