...
export const CheckoutFindFirstSchema: z.ZodType<Prisma.CheckoutFindFirstArgs> = z.object({ select: CheckoutFindFirstSelectSchema.optional(), include: CheckoutIncludeObjectSchema.optional(), orderBy: z.union([CheckoutOrderByWithRelationInputObjectSchema, CheckoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: CheckoutWhereInputObjectSchema.optional(), cursor: CheckoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CheckoutScalarFieldEnumSchema, CheckoutScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CheckoutFindFirstArgs>;

export const CheckoutFindFirstZodSchema = z.object({ select: CheckoutFindFirstSelectSchema.optional(), include: CheckoutIncludeObjectSchema.optional(), orderBy: z.union([CheckoutOrderByWithRelationInputObjectSchema, CheckoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: CheckoutWhereInputObjectSchema.optional(), cursor: CheckoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CheckoutScalarFieldEnumSchema, CheckoutScalarFieldEnumSchema.array()]).optional() }).strict();