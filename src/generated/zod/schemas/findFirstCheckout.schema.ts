...
export const CheckoutFindFirstSelectSchema: z.ZodType<Prisma.CheckoutSelect> = z.object({
...
export const CheckoutFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    billId: z.boolean().optional(),
    itemId: z.boolean().optional(),
    quantity: z.boolean().optional(),
...
export const CheckoutFindFirstSchema: z.ZodType<Prisma.CheckoutFindFirstArgs> = z.object({ select: CheckoutFindFirstSelectSchema.optional(), include: z.lazy(() => CheckoutIncludeObjectSchema.optional()), orderBy: z.union([CheckoutOrderByWithRelationInputObjectSchema, CheckoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: CheckoutWhereInputObjectSchema.optional(), cursor: CheckoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CheckoutScalarFieldEnumSchema, CheckoutScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CheckoutFindFirstArgs>;

export const CheckoutFindFirstZodSchema = z.object({ select: CheckoutFindFirstSelectSchema.optional(), include: z.lazy(() => CheckoutIncludeObjectSchema.optional()), orderBy: z.union([CheckoutOrderByWithRelationInputObjectSchema, CheckoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: CheckoutWhereInputObjectSchema.optional(), cursor: CheckoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CheckoutScalarFieldEnumSchema, CheckoutScalarFieldEnumSchema.array()]).optional() }).strict();