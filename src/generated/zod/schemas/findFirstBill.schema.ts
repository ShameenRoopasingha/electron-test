...
export const BillFindFirstSchema: z.ZodType<Prisma.BillFindFirstArgs> = z.object({ select: BillFindFirstSelectSchema.optional(), include: BillIncludeObjectSchema.optional(), orderBy: z.union([BillOrderByWithRelationInputObjectSchema, BillOrderByWithRelationInputObjectSchema.array()]).optional(), where: BillWhereInputObjectSchema.optional(), cursor: BillWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BillScalarFieldEnumSchema, BillScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BillFindFirstArgs>;

export const BillFindFirstZodSchema = z.object({ select: BillFindFirstSelectSchema.optional(), include: BillIncludeObjectSchema.optional(), orderBy: z.union([BillOrderByWithRelationInputObjectSchema, BillOrderByWithRelationInputObjectSchema.array()]).optional(), where: BillWhereInputObjectSchema.optional(), cursor: BillWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BillScalarFieldEnumSchema, BillScalarFieldEnumSchema.array()]).optional() }).strict();