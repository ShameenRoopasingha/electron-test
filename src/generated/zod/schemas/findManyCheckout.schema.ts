...
export const CheckoutFindManySchema: z.ZodType<Prisma.CheckoutFindManyArgs> = z.object({ select: CheckoutFindManySelectSchema.optional(), include: CheckoutIncludeObjectSchema.optional(), orderBy: z.union([CheckoutOrderByWithRelationInputObjectSchema, CheckoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: CheckoutWhereInputObjectSchema.optional(), cursor: CheckoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CheckoutScalarFieldEnumSchema, CheckoutScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CheckoutFindManyArgs>;

export const CheckoutFindManyZodSchema = z.object({ select: CheckoutFindManySelectSchema.optional(), include: CheckoutIncludeObjectSchema.optional(), orderBy: z.union([CheckoutOrderByWithRelationInputObjectSchema, CheckoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: CheckoutWhereInputObjectSchema.optional(), cursor: CheckoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CheckoutScalarFieldEnumSchema, CheckoutScalarFieldEnumSchema.array()]).optional() }).strict();