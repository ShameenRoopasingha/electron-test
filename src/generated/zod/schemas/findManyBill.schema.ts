...
export const BillFindManySelectSchema: z.ZodType<Prisma.BillSelect> = z.object({
...
export const BillFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    customerId: z.boolean().optional(),
    totalAmount: z.boolean().optional(),
...
export const BillFindManySchema: z.ZodType<Prisma.BillFindManyArgs> = z.object({ select: BillFindManySelectSchema.optional(), include: BillIncludeObjectSchema.optional(), orderBy: z.union([BillOrderByWithRelationInputObjectSchema, BillOrderByWithRelationInputObjectSchema.array()]).optional(), where: BillWhereInputObjectSchema.optional(), cursor: BillWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BillScalarFieldEnumSchema, BillScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BillFindManyArgs>;

export const BillFindManyZodSchema = z.object({ select: BillFindManySelectSchema.optional(), include: BillIncludeObjectSchema.optional(), orderBy: z.union([BillOrderByWithRelationInputObjectSchema, BillOrderByWithRelationInputObjectSchema.array()]).optional(), where: BillWhereInputObjectSchema.optional(), cursor: BillWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BillScalarFieldEnumSchema, BillScalarFieldEnumSchema.array()]).optional() }).strict();