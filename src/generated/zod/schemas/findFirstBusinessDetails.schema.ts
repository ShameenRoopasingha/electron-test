...
export const BusinessDetailsFindFirstSelectSchema: z.ZodType<Prisma.BusinessDetailsSelect> = z.object({
...
export const BusinessDetailsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    registrationNumber: z.boolean().optional(),
    address: z.boolean().optional(),
...
export const BusinessDetailsFindFirstSchema: z.ZodType<Prisma.BusinessDetailsFindFirstArgs> = z.object({ select: BusinessDetailsFindFirstSelectSchema.optional(), include: z.lazy(() => BusinessDetailsIncludeObjectSchema.optional()), orderBy: z.union([BusinessDetailsOrderByWithRelationInputObjectSchema, BusinessDetailsOrderByWithRelationInputObjectSchema.array()]).optional(), where: BusinessDetailsWhereInputObjectSchema.optional(), cursor: BusinessDetailsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BusinessDetailsScalarFieldEnumSchema, BusinessDetailsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BusinessDetailsFindFirstArgs>;

export const BusinessDetailsFindFirstZodSchema = z.object({ select: BusinessDetailsFindFirstSelectSchema.optional(), include: z.lazy(() => BusinessDetailsIncludeObjectSchema.optional()), orderBy: z.union([BusinessDetailsOrderByWithRelationInputObjectSchema, BusinessDetailsOrderByWithRelationInputObjectSchema.array()]).optional(), where: BusinessDetailsWhereInputObjectSchema.optional(), cursor: BusinessDetailsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BusinessDetailsScalarFieldEnumSchema, BusinessDetailsScalarFieldEnumSchema.array()]).optional() }).strict();