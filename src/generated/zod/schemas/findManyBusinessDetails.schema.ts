...
export const BusinessDetailsFindManySelectSchema: z.ZodType<Prisma.BusinessDetailsSelect> = z.object({
...
export const BusinessDetailsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    registrationNumber: z.boolean().optional(),
    address: z.boolean().optional(),
...
export const BusinessDetailsFindManySchema: z.ZodType<Prisma.BusinessDetailsFindManyArgs> = z.object({ select: BusinessDetailsFindManySelectSchema.optional(), include: z.lazy(() => BusinessDetailsIncludeObjectSchema.optional()), orderBy: z.union([BusinessDetailsOrderByWithRelationInputObjectSchema, BusinessDetailsOrderByWithRelationInputObjectSchema.array()]).optional(), where: BusinessDetailsWhereInputObjectSchema.optional(), cursor: BusinessDetailsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BusinessDetailsScalarFieldEnumSchema, BusinessDetailsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BusinessDetailsFindManyArgs>;

export const BusinessDetailsFindManyZodSchema = z.object({ select: BusinessDetailsFindManySelectSchema.optional(), include: z.lazy(() => BusinessDetailsIncludeObjectSchema.optional()), orderBy: z.union([BusinessDetailsOrderByWithRelationInputObjectSchema, BusinessDetailsOrderByWithRelationInputObjectSchema.array()]).optional(), where: BusinessDetailsWhereInputObjectSchema.optional(), cursor: BusinessDetailsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BusinessDetailsScalarFieldEnumSchema, BusinessDetailsScalarFieldEnumSchema.array()]).optional() }).strict();