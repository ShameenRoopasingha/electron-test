...
export const UserSessionFindFirstSchema: z.ZodType<Prisma.UserSessionFindFirstArgs> = z.object({ select: UserSessionFindFirstSelectSchema.optional(), include: UserSessionIncludeObjectSchema.optional(), orderBy: z.union([UserSessionOrderByWithRelationInputObjectSchema, UserSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserSessionWhereInputObjectSchema.optional(), cursor: UserSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserSessionScalarFieldEnumSchema, UserSessionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UserSessionFindFirstArgs>;

export const UserSessionFindFirstZodSchema = z.object({ select: UserSessionFindFirstSelectSchema.optional(), include: UserSessionIncludeObjectSchema.optional(), orderBy: z.union([UserSessionOrderByWithRelationInputObjectSchema, UserSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserSessionWhereInputObjectSchema.optional(), cursor: UserSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserSessionScalarFieldEnumSchema, UserSessionScalarFieldEnumSchema.array()]).optional() }).strict();