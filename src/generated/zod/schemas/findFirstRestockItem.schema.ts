...
export const RestockItemFindFirstSelectSchema: z.ZodType<Prisma.RestockItemSelect> = z.object({
...
export const RestockItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    restockId: z.boolean().optional(),
    itemId: z.boolean().optional(),
    quantity: z.boolean().optional(),
...
export const RestockItemFindFirstSchema: z.ZodType<Prisma.RestockItemFindFirstArgs> = z.object({ select: RestockItemFindFirstSelectSchema.optional(), include: RestockItemIncludeObjectSchema.optional(), orderBy: z.union([RestockItemOrderByWithRelationInputObjectSchema, RestockItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: RestockItemWhereInputObjectSchema.optional(), cursor: RestockItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RestockItemScalarFieldEnumSchema, RestockItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RestockItemFindFirstArgs>;

export const RestockItemFindFirstZodSchema = z.object({ select: RestockItemFindFirstSelectSchema.optional(), include: RestockItemIncludeObjectSchema.optional(), orderBy: z.union([RestockItemOrderByWithRelationInputObjectSchema, RestockItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: RestockItemWhereInputObjectSchema.optional(), cursor: RestockItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RestockItemScalarFieldEnumSchema, RestockItemScalarFieldEnumSchema.array()]).optional() }).strict();